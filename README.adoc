...
pass:[<a rel="license" href="https://k8spatterns.io"><img alt="Kubernetes Patterns Duck" style="display: block; border-width:0; float: left" align="left" src="https://avatars2.githubusercontent.com/u/27804949?s=200&v=4" /></a>]
