...
* link:openshift/README.adoc[Openshift builds] is an example how to use a chained build with an S2I build followed by a Docker build for creating a simple Spring Boot based REST service.
