...
* https://cloud.google.com/kubernetes-engine/[Google Kubernetes Engine] (GKE). For new users Google provides a free budget for a certain time period so that you can easily try things out.
* https://docs.microsoft.com/en-us/azure/aks/[Azure Kubernetes Service] (AKS) by Microsoft
* Amazon's https://aws.amazon.com/eks/[Elastic Container Service] (EKS)
* Managed Kubernetes cluster on https://www.digitalocean.com/products/kubernetes/[Digital Ocean]
